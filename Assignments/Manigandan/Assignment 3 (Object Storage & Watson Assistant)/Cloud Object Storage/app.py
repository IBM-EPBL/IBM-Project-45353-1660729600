...
@app.route('/')
def index():
    files = get_bucket_contents('anime-bucket')
...
def deletefile():
   if request.method == 'POST':
       ...
       return render_template('message.html', msg = "File Deleted Successfully!")
...
def upload():
   if request.method == 'POST':
       ...
       return render_template('message.html', msg = "File Uploaded Successfully!")
